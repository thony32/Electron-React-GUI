...
import ReactFlow, { Controls, Background, MiniMap, applyNodeChanges, OnNodesChange, NodeTypes, OnEdgesChange, applyEdgeChanges, ReactFlowProvider } from "reactflow"
    ...
    <ReactFlowProvider>
      <main className="h-screen overflow-hidden" onDrop={handleDrop} onDragOver={handleDragOver} onContextMenu={showContextMenu}>
        <div className="w-full h-full flex justify-center items-center">
          ...
          <ReactFlow nodes={nodes} nodeTypes={nodeTypes} onNodesChange={onNodesChange} onNodesDelete={onNodesDelete} onConnect={() => {}} fitView onEdgesChange={onEdgesChange} edges={edges} onNodeClick={onNodeClick} deleteKeyCode={46 as any} /* snapToGrid={true} snapGrid={[5, 5]}*/>
          ...
          <button className="btn btn-primary" onClick={onNodeDeleteClick}>
            Delete
          </button>
