...
const ImageNode = ({ id, data, selected, isConnectable }: NodeProps) => {
    ...
    return (
        <div style={parentDivStyle}>
            ...
            <div ref={rotateControlRef} style={rotateButtonStyle} className={`nodrag absolute w-[40px] h-[40px] bg-base-100 left-1/2 top-[-25px] rounded-full transform translate-x-[-50%] translate-y-[-50%] cursor-alias`}>
